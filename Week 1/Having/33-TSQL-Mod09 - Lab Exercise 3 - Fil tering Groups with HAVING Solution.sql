...
-- Task 2 - Solution
-- 
-- Write a SELECT statement to retrieve the number of customers based on the first letter of the values in
-- the contactname column from the Sales.Customers table. Add an additional column to show the 
