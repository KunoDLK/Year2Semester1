-- TSQL-Mod12 - Set Operators
-- Author: Mansha Nawaz

-- TSQL-Mod12 - 31 - Demonstration C.sql - TSQL Create inline Table-valued Function

-- Advanced Level: Functions with Joins 
...
-- Step 4: Test the function with a CROSS APPLY
...
---------------------------------------------------------------------
-- Step 5: If you wish to drop (delete) the function 
---------------------------------------------------------------------
IF OBJECT_ID('dbo.fn_TopProductsByShipper') IS NOT NULL
	DROP FUNCTION dbo.fn_TopProductsByShipper;
GO

-- more examples of JOINS to relate 2 tables

-- Step 6: Using OUTER APPLY
